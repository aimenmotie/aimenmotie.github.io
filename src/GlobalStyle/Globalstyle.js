...
.border-line-v:before {
  ...
  width: 1px;
  height: 100%;
  background: radial-gradient(ellipse at top, rgba(${({ theme }) => theme.highlight.rgb.primary}, 0.2) 0%, rgba(255, 255, 255, 0) 70%);
}
...
.link:before {
  background: radial-gradient(ellipse at top, rgba(${({ theme }) => theme.highlight.rgb.primary}, 0.15) 0%, rgba(255, 255, 255, 0) 70%);
}
