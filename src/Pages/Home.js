    ...
    <Wrapper>
      <section className="card-section home-card">
        <div className="profile">
          ...
          <div className="image">
            <img
              src="/assets/aimen_profile_raw_v2.jpg"
              width="936"
              height="936"
              alt="profile"
              loading="lazy"
          ...
          <div className="subtitle subtitle-typed">
            <TypeWriterEffect
              ...
              startDelay={2000}
              cursorColor="#d32f2f"
              multiText={["PhD Candidate", "Chemical Engineer", "Process Control Specialist", "Researcher"]}
              multiTextDelay={1000}
              typeSpeed={50}
              multiTextLoop
            />
          ...
          <div className="social">
            <a
              className="link"
              href="https://www.linkedin.com/in/babaci-aimen"
              rel="noreferrer"
              target="_blank"
              aria-label="linkedin"
            ...
            <a
              className="link"
              href="https://github.com/aimen-babaci"
              rel="noreferrer"
              target="_blank"
              aria-label="github"
  ...
  .card-section {
    ...
    .profile {
      ...
      .slide {
        ...
        width: 100%;
        height: 52%;
        background-image: url("/assets/aimen_profile_banner_v3.png");
