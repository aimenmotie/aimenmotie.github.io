            ...
            <div className="row">
              <div className="col col-6 border-line-v">
                <div className="text-box" data-aos="fade-up">
                  <p>
                    <b>I'm</b> a PhD Candidate in Chemical Engineering at Eskisehir Osmangazi University. My research focuses on wastewater treatment, adsorption kinetics, and advanced polymer materials like Polyetheretherketone (PEEK). With a background in process engineering and industrial experience as an R&D Specialist and Physicochemical Analyst, I am dedicated to developing sustainable solutions for environmental challenges.
                  </p>
                </div>
              </div>
              <div className="col col-6 border-line-v">
                <div className="info-list" data-aos="fade-up">
                  <ul>
                    ...
                    <li>
                      <strong>Birthday: </strong>22 August 1997
                    </li>
                    <li>
                      <strong>Hometown: </strong>Algiers, Algeria
                    </li>
                    <li>
                      <strong>Gmail: </strong>aymenmotie.babaci@gmail.com
                    </li>
                    <li>
                      <strong>Residence: </strong>Eskisehir, Turkey
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="col col-6 border-line-v">
                <div className="hobby-list">
                  <ul>
                    ...
                    <li>
                      <strong>Scientific Writing</strong>
                    </li>
                    <li>
                      <strong>Physics & Math Volunteering</strong>
                    </li>
                    <li>
